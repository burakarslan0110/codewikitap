...
```
   ...
   ─────────────────────────────────────────────────────────────
   Yaklaşık 12 saniye sonra üç indeks cache.db içinde hazır. Sonraki
   her find_chunks çağrısı 50 ms'in altında döner; ilk açılış gecikmesi yok.
```

---

Sıradaki: [Yapılandırma](/tr/guide/configuration) — ortam değişkenleri, sorun giderme ve operatör ayarları.
